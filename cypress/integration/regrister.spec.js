...
describe("Register", () =>{
    ...
    it("Register: Valid registration", () =>{
        ...
        cy.wait(2000)
        cy.get(signUpPage.firstName).should('be.visible').type(data.accountDetails.firstName)
        cy.get(signUpPage.lastName).should('be.visible').type(data.accountDetails.lastName)
